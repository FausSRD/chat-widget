(function () {
    ...
    `
        ...
        /* =========================
            ...
            /* Neutralizar SVG currentColor de Elementor */
            .lh-chat-widget svg {
            color: inherit;
            stroke: currentColor;
            fill: none;
            ...
            /* Neutralizar headings de WP/Elementor */
            .lh-chat-widget h1,
            .lh-chat-widget h2,
            .lh-chat-widget h3,
            .lh-chat-widget h4,
            ...
            .lh-form-input:focus {
                outline: none;
                border-color: ${config.headerColor};
            }
            ...
            function initializeChat(widgetContainer, config) {
                ...
                function manageExceptions(error) {
                    ...
                    switch (errorCode) {
                        ...
                        case 'MAX_LIMIT_COUNT_REACHED': return 'Message limit reached! You wll be able to send more messages in around 30 minutes.';
